...
reproduce the experiments in our NeurIPS2019 paper [Twin Auxiliary Classifiers GAN](https://arxiv.org/abs/1907.02690) by [Mingming Gong*](https://mingming-gong.github.io/), [Yanwu Xu*](http://xuyanwu.github.io), [Chunyuan Li](http://chunyuan.li/), [Kun Zhang](http://www.andrew.cmu.edu/user/kunz1/), [and Kayhan Batmanghelich\Letter](https://kayhan.dbmi.pitt.edu/)

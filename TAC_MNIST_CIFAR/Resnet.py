...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.optim = optim.Adam(self.parameters(), lr=0.01, momentum=0.9, weight_decay=5e-4)
...
class ResNet_64(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.optim = optim.SGD(self.parameters(), lr=0.01, momentum=0.9, weight_decay=5e-4)
...
def multi_resolution_resnet(resolution,nclass):
    if resolution == 32:
        return ResNet(BasicBlock, [3, 4, 6, 3], num_classes=nclass)
    elif resolution == 64:
        return ResNet_64(BasicBlock, [3, 4, 6, 3], num_classes=nclass)
